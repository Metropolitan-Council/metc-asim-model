...
FILEO NETO = "%SCENARIO_DIR%\transit\XIT_LDNET_DRE_%ITER%_@TPER2@.net"
FILEI FAREMATI[1] = "%XIT_FAREMAT%"
 ...
 PARAMETERS TRIPSIJ[1] = MI.1.TrnDriveEgress, NOROUTEMSGS = 9999, NOROUTEERRS = 9999          ; ASSIGN Drive TO Transit TRIPS
