...
RUN PGM=PUBLIC TRANSPORT PRNFILE="%SCENARIO_DIR%\transit\XIT_WK_PRN_@TPER@_%TPER%.prn" MSG='@TPER@ Walk Transit Skim - Step 1'
...
FILEO MATO[1] = "%SCENARIO_DIR%\transit\XIT_WK_SKIM_%ITER%_@TPER@.TMP",
...
FILEI NTLEGI[3] = "%SCENARIO_DIR%\transit\XIT_XFER_NTL_%ITER%_@TPER@.NTL"
FILEI NTLEGI[2] = "%SCENARIO_DIR%\transit\XIT_DRACC_NTL_%ITER%_@TPER@.NTL"
FILEI NTLEGI[1] = "%SCENARIO_DIR%\transit\XIT_WKACC_NTL_%ITER%_@TPER@.NTL"
