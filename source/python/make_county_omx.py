...
def read_land_use(land_use_file, index_field_name, field_name, matrix_name, output_file):
    ...
    m.create_mapping('ZoneID', mapping)
...
if __name__ == "__main__":
    ...
    read_land_use(args.land_use_file, args.index_field_name, args.field_name, args.matrix_name, args.output_file)
