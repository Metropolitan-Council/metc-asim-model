...
if(IS_BASE_SURVEY=="Yes"){
  base_scenario_name = CENSUS_SCENARIO_NAME
}

p <- plotly_bar_plotter(data = sd.autoown, xlabel = "Number of Vehicles", ylabel = "Percent", ynames = c(base_scenario_name, BUILD_SCENARIO_NAME), percent = T, height = 225)
