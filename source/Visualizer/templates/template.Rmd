...
sd.purpose <- get_sharedData(data_df1 = base_df, data_df2 = build_df, run1_name = BUILD_SCENARIO_NAME,
...
#   name = 'Survey'
# }else{
  # base_df <- census_data[[which(census_csv_names=="countyFlowsCensus")]]
  # name = 'Census'
# }
base_df <- base_data[[which(base_csv_names=="countyFlows")]]
name = 'Survey'
