...
bscols(widths=c(12),filter_select("Child_type", "Select Child Type", sd.pertype, ~grp_var,multiple=F))
...
### {data-height=300, data-width=750}
```{r schesc3}
...
#t1 <- kable(base_df, format = 'html', caption = paste("Workers with School Drops Offs and Pickups -", BASE_SCENARIO_ALT), digits = 0, row.names = F, align = 'r', format.args = list(big.mark = ','), td.attr = "padding='3px'")


t1 <- kable(base_df, format = "html", caption = paste("Workers with School Drops Offs and Pickups -", BASE_SCENARIO_ALT), digits = 0, row.names = F, align = 'r', format.args = list(big.mark = ','), col.names = c("Drop Off", "Rideshare", "Pure Escort", "No Escort", "Total")) %>%
...
t2 <- kable(build_df[,c("DropOff", "Ride.Share", "Pure.Escort", "No.Escort", "Total")], format = "html", caption = paste("Workers with School Drops Offs and Pickups -", BUILD_SCENARIO_NAME), digits = 0, row.names = F, align = 'r', format.args = list(big.mark = ','), col.names = c("Drop Off", "Rideshare", "Pure Escort", "No Escort", "Total")) %>%
  kable_styling("striped", full_width = F)
...
Total Assignment Summaries{data-navmenu="Assignment"}
============================================
