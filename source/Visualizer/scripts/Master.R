...
base_data <- lapply(base_csv, function(x){
	print(paste("[Base] Reading ", x, "...", sep = ""))
...
build_data <- lapply(build_csv, function(x){
	print(paste("[Build] Reading ", x, "...", sep = ""))
	read.csv(x, row.names = NULL)})
