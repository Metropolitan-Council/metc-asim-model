...
trips$TRIPMODE_RECODE[trips$TOURMODE==2]  = '2_HOV2'
trips$TRIPMODE_RECODE[trips$TOURMODE==3]  = '3_HOV3'
trips$TRIPMODE_RECODE[trips$TOURMODE==4]  = '4_WALK'
trips$TRIPMODE_RECODE[trips$TOURMODE==5]  = '5_BIKE'
trips$TRIPMODE_RECODE[trips$TOURMODE==6]  = '6_WALK_LOCAL'
trips$TRIPMODE_RECODE[trips$TOURMODE==7]  = '7_WALK_PREMIUM'
trips$TRIPMODE_RECODE[trips$TOURMODE==8]  = '8_WALK_MIXED'
trips$TRIPMODE_RECODE[trips$TOURMODE==9]  = '9_PNR_LOCAL'
trips$TRIPMODE_RECODE[trips$TOURMODE==10]  = '10_PNR_PREMIUM'
trips$TRIPMODE_RECODE[trips$TOURMODE==11]  = '11_PNR_MIXED'
trips$TRIPMODE_RECODE[trips$TOURMODE==12]  = '12_KNR_LOCAL'
trips$TRIPMODE_RECODE[trips$TOURMODE==13]  = '13_KNR_PREMIUM'
trips$TRIPMODE_RECODE[trips$TOURMODE==14]  = '14_KNR_MIXED'
trips$TRIPMODE_RECODE[trips$TOURMODE==15]  ='15_TNC_SINGLE'
trips$TRIPMODE_RECODE[trips$TOURMODE==16]  ='11_TNC_SHARED'
trips$TRIPMODE_RECODE[trips$TOURMODE==17]  ='17_TAXI'
trips$TRIPMODE_RECODE[trips$TOURMODE==18]  ='18_SCHOOLBUS'
trips$TRIPMODE_RECODE[trips$TOURMODE==19]  ='19_OTHER'
...
tripModeProfile1_vis = reshape2::melt(tripModeProfile1_vis, id = c("id"))
...
tripModeProfile2_vis = reshape2::melt(tripModeProfile2_vis, id = c("id"))
...
tripModeProfile3_vis = reshape2::melt(tripModeProfile3_vis, id = c("id"))
...
tripModeProfile4_vis = reshape2::melt(tripModeProfile4_vis, id = c("id"))
...
colnames(tripModeProfile) = c("tourmode1", "tourmode2", "tourmode3", "tourmode4", "tourmode5", "tourmode6", "tourmode7", 
                              "tourmode8", "tourmode9", "tourmode10")
...
tripModeProfile5_vis = reshape2::melt(tripModeProfile5_vis, id = c("id"))
...
tripModeProfile6_vis = reshape2::melt(tripModeProfile6_vis, id = c("id"))
...
tripModeProfile7_vis = reshape2::melt(tripModeProfile7_vis, id = c("id"))
...
tripModeProfile9_vis = reshape2::melt(tripModeProfile9_vis, id = c("id"))
