...
if __name__ == "__main__":
    ...
    for dayno in range(1,5):
        ...
        # read in PLACE records into a data frame object, df_place       
        df_place = pd.read_csv(IN_DIR+'place_'+str(dayno)+'.csv', quotechar='"', encoding='ISO-8859-1')
        ...
        OUT_DIR_PATH = OUT_DIR +'day'+str(dayno)+'/'
        ...
        print_in_same_files(hh_list, OUT_DIR_PATH)
