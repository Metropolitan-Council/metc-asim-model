...
std_DF <- get_standardDF(data_df1 = base_df, data_df2 = census_df, x = "HHSIZE", y = c("freq"))
p <- plotly_bar_plotter(data = std_DF, xlabel = "HH Size", ylabel = "Percent", ynames = c(BASE_SCENARIO_NAME, 'Census'), percent = T)
p
...
std_DF <- get_standardDF(data_df1 = base_df, data_df2 = census_df, x = "HHVEH", y = c("freq"))

p <- plotly_bar_plotter(data = std_DF, xlabel = "Number of Vehicles", ylabel = "Percent", ynames = c(BASE_SCENARIO_NAME, AO_CENSUS_SHORT), percent = T, height = 225)
p
```
...
```{r job_wrk1a}
#knitr::include_graphics(file.path(SYSTEM_JPEG_PATH, "workersByCounty.jpeg"))
# knitr::include_graphics(file.path(SYSTEM_JPEG_PATH, "workersByTAZ_County.jpeg"))
```
...
p1 <- plotly_density_plotter(sd.purpose, index = "one", xlabel = "Tour Departure", percent = T, left_offset = 25,
                             tickvals = seq(1,19), ticktext = todBins, bottom_offset = 150, tickangle = 315, height = 275)
...
p3 <- plotly_density_plotter(sd.purpose, index = "three", xlabel = "Tour Duration", percent = T, left_offset = 25,
                             tickvals = seq(1,19), ticktext = durBins, bottom_offset = 50, tickangle = 315, height = 225)
...
p1 <- plotly_density_plotter(sd.purpose, index = "one", xlabel = "Stop Departure", percent = T, left_offset = 25,
                             tickvals = seq(1,24), ticktext = todBins, bottom_offset = 150, tickangle = 315, height = 400)
