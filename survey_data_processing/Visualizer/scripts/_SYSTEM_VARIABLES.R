...
tourMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit',  'School Bus','Ridehail')
tripMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'School Bus','Taxi')
