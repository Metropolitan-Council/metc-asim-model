...
ABM_SUMMARY_DIR         =  settings$abm_summary_dir
...
# Comes from get_census_data script

# Uncomment this/comment model if you want to compare survey to census
...
zone_file =file.path(settings$zone_dir, 'TAZ2010.shp')
# tract_to_taz_file = file.path(settings$zone_dir, 'TAZ2010.shp')
...
setDT(hh)
hh[, HH_TRACT_FIPS := str_sub(bg_geoid, start = 1, end = 11)]
